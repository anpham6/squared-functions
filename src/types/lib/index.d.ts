...
import type { HttpProxyData, HttpRequest, HttpRequestClient, HttpRequestOptions, HttpVersionSupport, IHttpHost } from './http';
...
declare namespace functions {
    ...
    interface IFileManager extends IModule {
        ...
        getHttpClient(uri: StringOfURL, options: HttpRequestOptions): HttpRequestClient;
        getHostProxy(host: IHttpHost, uri: string): Null<HttpProxyData>;
        fetchBuffer(uri: StringOfURL, options?: HttpRequestOptions): Promise<Null<BufferContent>>;
