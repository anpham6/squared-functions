...
async function downloadOCI(this: IFileManager, service: string, credential: OCICloudCredential, filename: string, versionId: Undef<string>, success: (value?: unknown) => void) {
    ...
    return (require('../../s3/download') as DownloadHost).call(this, service, credential, filename, versionId, success);
}
