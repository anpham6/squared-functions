...
function uploadHandlerS3(this: IFileManager, config: S3CloudService) {
    let s3: aws.S3;
    try {
        ...
        this.writeFail('Install SDK? [npm i aws-sdk]', 'S3');
        throw err;
    }
